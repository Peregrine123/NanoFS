...
这个脚本会自动：
1. ✅ 清理旧的测试镜像
2. ✅ 运行完整功能覆盖测试 (test_full_coverage)
3. ✅ 运行错误处理测试 (test_error_handling)
4. ✅ 运行压力和性能测试 (test_stress)
5. ✅ 生成测试总结报告

**测试覆盖**：
- ✅ 完整功能覆盖测试 (7个核心场景，全部通过)
- ✅ 错误处理测试 (6/8个场景通过)
- ✅ 压力测试 (3/6个场景通过)
- ✅ Rust/C FFI集成验证
- ✅ Journal事务和崩溃恢复
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[测试 1/3] 完整功能覆盖测试 (test_full_coverage)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🎉 所有测试通过！(7/7)

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[测试 2/3] 错误处理测试 (test_error_handling)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
测试2状态：部分通过 (6/8个测试通过)

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[测试 3/3] 压力和性能测试 (test_stress)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
✓ 成功创建 254 个小文件
测试3状态：部分通过 (3/6个测试通过)
...
╚══════════════════════════════════════════════════════════╝
  ...
  [1] test_full_coverage:   ✅ 通过 (7/7)
  [2] test_error_handling:  ⚠️  部分通过 (6/8)
  [3] test_stress:          ⚠️  部分通过 (3/6)
